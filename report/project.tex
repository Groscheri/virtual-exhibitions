...
\end{figure}
  ...
  % TODO (1) Captures use cases;
  
  % Actors:
  % - Product chooser
  % - Auctionner (DutchAuction)
  % - Bidder (DutchAuction)
  % - Strategist
  % - Proposer
  % - Buyer
  ...
  % - Auctionneer (DutchAuction): Call for proposal / Manage proposals / Accept proposal / Refuse proposal(s)
  ...
  \subsubsection{Roles}
  % TODO (2) Identify roles from use cases;
  % Goals / Attributes / Services (methods)
  
  % Roles:
  % - Product chooser : product list / getHighQuality / getLowQuality
  % - Auctionner (DutchAuction) : call for proposal (price) / accept / refuse
  ...
  % TODO (3) Constructs role organization;
  
  % Artist Manager  <-> Curator <-> Profiler
  % reuse previous role to construct organization
  ...
  it goes first in roles definition with 4 different characteristics: responsabilities, 
  ...
  behaviors in JADE framework) in role-based modeling.
